      ...
      <div className="mx-auto flex h-14 max-w-screen-2xl items-center gap-3 px-4 sm:px-6">
        <Link to="/" className="flex items-center gap-2.5 font-display group">
          ...
          <div className="hidden flex-col leading-tight sm:flex">
            <span className="text-sm font-bold tracking-tight text-foreground/90">Placement Intelligence</span>
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
              <Button variant="ghost" size="icon" className="lg:hidden rounded-full hover:bg-secondary">
